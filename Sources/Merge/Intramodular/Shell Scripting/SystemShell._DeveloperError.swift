        ...
        public var description: String {
            switch self {
                case .borrowedShellOwnedOperation(let operation):
                    return "Cannot perform \(operation) on a SystemShell borrowed through AnyCommandLineTool.withSystemShell. The caller that creates or owns the shell must perform this operation."
                case .borrowedShellMutation(let property):
                    return "Cannot mutate \(property) on a SystemShell borrowed through AnyCommandLineTool.withSystemShell. Use withConfiguration(applying:perform:) to derive a scoped child shell."
                case .conflictingConfigurationDifferences:
                ...
                case .invalidBorrowedShellLease:
                    return "Cannot use a SystemShell borrowed through AnyCommandLineTool.withSystemShell after the closure has returned."
